...
from .mcp_alpha_vantage import (
    get_stock as get_mcp_stock,
    get_indicator as get_mcp_indicator,
    get_fundamentals as get_mcp_fundamentals,
    get_balance_sheet as get_mcp_balance_sheet,
    get_cashflow as get_mcp_cashflow,
    get_income_statement as get_mcp_income_statement,
    get_insider_transactions as get_mcp_insider_transactions,
    get_news as get_mcp_news,
    get_global_news as get_mcp_global_news,
    MCPError,
    MCPRateLimitError,
)
...
VENDOR_LIST = [
    "yfinance",
    "alpha_vantage",
    "mcp_alpha_vantage",  # Alpha Vantage via MCP (Model Context Protocol)
]
...
VENDOR_METHODS = {
    ...
    "get_stock_data": {
        ...
        "mcp_alpha_vantage": get_mcp_stock,
        "yfinance": get_YFin_data_online,
    },
    # technical_indicators
    "get_indicators": {
        "alpha_vantage": get_alpha_vantage_indicator,
        "mcp_alpha_vantage": get_mcp_indicator,
        "yfinance": get_stock_stats_indicators_window,
    },
    # fundamental_data
    "get_fundamentals": {
        "alpha_vantage": get_alpha_vantage_fundamentals,
        "mcp_alpha_vantage": get_mcp_fundamentals,
        "yfinance": get_yfinance_fundamentals,
    },
    "get_balance_sheet": {
        "alpha_vantage": get_alpha_vantage_balance_sheet,
        "mcp_alpha_vantage": get_mcp_balance_sheet,
        "yfinance": get_yfinance_balance_sheet,
    },
    "get_cashflow": {
        "alpha_vantage": get_alpha_vantage_cashflow,
        "mcp_alpha_vantage": get_mcp_cashflow,
        "yfinance": get_yfinance_cashflow,
    },
    "get_income_statement": {
        "alpha_vantage": get_alpha_vantage_income_statement,
        "mcp_alpha_vantage": get_mcp_income_statement,
        "yfinance": get_yfinance_income_statement,
    },
    # news_data
    "get_news": {
        "alpha_vantage": get_alpha_vantage_news,
        "mcp_alpha_vantage": get_mcp_news,
        "yfinance": get_news_yfinance,
    },
    "get_global_news": {
        "yfinance": get_global_news_yfinance,
        "alpha_vantage": get_alpha_vantage_global_news,
        "mcp_alpha_vantage": get_mcp_global_news,
    },
    "get_insider_transactions": {
        "alpha_vantage": get_alpha_vantage_insider_transactions,
        "mcp_alpha_vantage": get_mcp_insider_transactions,
